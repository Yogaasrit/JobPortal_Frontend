...
const AddSkill = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.put(`http://localhost:9090/edit-skill/${id}`,skill)
  ...
  const loadSkill=async()=>{
    const skill =await axios.get(`http://localhost:9090/viewParticularSkill/${id}`)
    console.log(skill)
    setSkill(skill.data)
  }
  useEffect(()=>{
  ...
  return (
    <div>
      ...
      <div className="card p-5 shadow" style={{ maxWidth: "900px", margin: "auto", marginTop: "20px" }}>
        <h2 className="card-title text-center mb-4">Upgrade Skill</h2>
